...
namespace RegistroEventoAssociadov4.Controllers
{
    public class ProdutoesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Descricao,Preco,FornecedorId")] Produto produto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Descricao,Preco,FornecedorId")] Produto produto)
        {
            if (id != produto.Id)
            {
                return NotFound();
